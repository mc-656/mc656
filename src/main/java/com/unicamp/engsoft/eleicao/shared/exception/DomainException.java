 ...
 *
 * <p>Cada subclasse carrega o status HTTP que a representa, de modo que o
 * {@link GlobalExceptionHandler} traduza a exception sem precisar conhecer
 * cada caso individualmente.
 * 
 * Na prática, converte um erro de regra de negócios ou de recursos em semântica
 * de erro HTTP.
 */
